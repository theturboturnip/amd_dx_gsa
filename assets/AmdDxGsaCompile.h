...
typedef struct _AmdDxGsaCompileShaderInput
{
    ...
    /// Input type
    // TURBOTURNIP CHANGE - for Rust bindgen this had to be changed to `enum AmdDxGsaInputType` instead of just `AmdDxGsaInputType`.
    enum AmdDxGsaInputType            inputType;
